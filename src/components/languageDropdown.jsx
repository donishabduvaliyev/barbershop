  ...
  return (
    <>
      ...
      <button
        ...
        className="px-4 py-2 bg-blue-700 dark:bg-purple-900 text-white rounded-lg shadow-md hover:bg-blue-800 dark:hover:bg-purple-950 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
      >
