            ...
            {bookingToCancel && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
                    <div className="bg-white dark:bg-zinc-800 p-6 rounded-2xl shadow-xl text-center w-80">
                        ...
                        <p className="text-sm text-zinc-600 dark:text-zinc-400 my-4">{t('SureCancelation')}</p>
                        <div className="flex space-x-2">
                            <button onClick={() => setBookingToCancel(null)} className="flex-1 py-2 bg-zinc-200 dark:bg-zinc-700 rounded-lg">{t('no')}</button>
